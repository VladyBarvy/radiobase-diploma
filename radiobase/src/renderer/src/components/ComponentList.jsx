...
// // 🎯 ХУКИ ДЛЯ ОТЛАДКИ - ВЫНЕСЕМ ИХ ОТДЕЛЬНО
// const useRenderDebug = (componentName, props) => {
//   const renderCount = useRef(0);
//   const prevProps = useRef({});
...
// // 🎯 УТИЛИТА ДЛЯ ЗАМЕРА ПРОИЗВОДИТЕЛЬНОСТИ (не хук!)
// const createPerformanceMeasure = (operationName) => {
//   const startTime = performance.now();
...
//   // 🎯 ИНИЦИАЛИЗАЦИЯ СИСТЕМЫ ОТЛАДКИ
//   useRenderDebug('ComponentList', { category, component });
...
//   useEffect(() => {
//     if (process.env.NODE_ENV !== 'production') {
//       console.group('🔍 ComponentList State Update');
...
//       console.groupEnd();
//     }
//   }, [component, category, isImageModalOpen, imagePreview]);

//   // 🎯 ВАЛИДАЦИЯ ВХОДЯЩИХ ДАННЫХ
//   useEffect(() => {
//     if (process.env.NODE_ENV !== 'production') {
//       if (component && typeof component !== 'object') {
//         console.error('❌ Invalid component prop:', component);
//       }
...
//         } catch (error) {
//           console.error('❌ Invalid parameters format:', error);
//         }
//       }
//     }
//   }, [component]);
...
//   // Мемоизируем вычисляемые значения С ОТЛАДКОЙ
//   const componentName = useMemo(() => {
...
//   const categoryName = useMemo(() => {
//     const name = component?.category_name || category?.name || 'Неизвестно';
//     if (process.env.NODE_ENV !== 'production') {
//       console.log('🧮 Computing categoryName:', name);
//     }
//     return name;
...
//   // Мемоизируем форматирование даты С ЗАМЕРОМ ПРОИЗВОДИТЕЛЬНОСТИ
//   const formattedDate = useMemo(() => {
//     // Используем утилиту вместо хука
//     const measurePerf = createPerformanceMeasure('formatDate');
...
//     const result = formatDate(component?.updated_at);
//     measurePerf();
    
//     return result;
//   }, [component?.updated_at]);

//   // Мемоизируем параметры С РАСШИРЕННОЙ ОТЛАДКОЙ
//   const parameters = useMemo(() => {
//     // Используем утилиту вместо хука
//     const measurePerf = createPerformanceMeasure('parseParameters');
...
//           console.log('⚠️ Parameters appear to be a parsed string, reconstructing...');
//           const reconstructedString = keys.map(key => parameters[key]).join('');
//           try {
//             const parsed = JSON.parse(reconstructedString);
//             console.log('✅ Successfully parsed reconstructed parameters');
//             console.groupEnd();
//             measurePerf();
//             return parsed;
//           } catch (error) {
...
//           }
//         }
//         console.log('✅ Normal parameters object');
//         console.groupEnd();
//         measurePerf();
//         return parameters;
//       }
...
//           console.log('✅ Successfully parsed parameters string');
//           console.groupEnd();
//           measurePerf();
//           return parsed;
//         } catch {
...
//   // Оптимизированные обработчики с useCallback И ЛОГИРОВАНИЕМ
//   const handleEditClick = useCallback(() => {
//     if (process.env.NODE_ENV !== 'production') {
//       console.group('✏️ Edit Component Clicked');
...
//         console.group('💾 Saving Component Image');
//         console.log('🖼️ Image preview exists:', !!imagePreview);
//         console.log('📋 Target component:', component?.id);
//       }
...
//   // 🎯 ОТЛАДКА УСЛОВИЙ РЕНДЕРИНГА
//   useEffect(() => {
//     if (process.env.NODE_ENV !== 'production') {
//       console.group('🎯 Render Conditions');
//       console.log('📝 Has description:', hasDescription);
//       console.log('⚙️ Has parameters:', hasParameters, `(${Object.keys(parameters).length} items)`);
//       console.log('🖼️ Has image:', hasImage);
//       console.log('🔗 Has datasheet:', hasDatasheet);
//       console.log('📦 Component provided:', !!component);
//       console.groupEnd();
//     }
//   }, [hasDescription, hasParameters, hasImage, hasDatasheet, component, parameters]);
